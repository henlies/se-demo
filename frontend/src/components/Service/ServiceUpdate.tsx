import { AccessoriesInterface, DrinksInterface, FoodsInterface, ServicesInterface } from "../../models/IService";
...
function ServiceUpdate() {
    ...
    function submit() {
        let data = {
            ...
            CustomerID: Number(localStorage.getItem("uid")),
            Time: time,
